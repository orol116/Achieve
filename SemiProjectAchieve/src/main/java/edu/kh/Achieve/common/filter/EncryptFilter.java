...
import edu.kh.Achieve.common.wrapper.EncryptWrapper;
...
//		doFilter 메서드 매개변수는 부모타입인 ServletRequest -> 다운캐스팅 필요
		HttpServletRequest req = (HttpServletRequest)request;
		
//		파라미터를 다시 세팅하는 방법은 필터에서 불가능
//		-> Servlet의 Wrapper 클래스를 이용해서 HttpServletRequest 메서드를 오버라이딩 할 수 있음
