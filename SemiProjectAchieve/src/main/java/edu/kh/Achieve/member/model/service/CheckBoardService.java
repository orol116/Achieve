...
public class CheckBoardService {
	 ...
	 * @throws Exception
	 */
	public Map<String, Object> selectCheckBoardList(int type, int cp) throws Exception{
		...
		// 3. 게시글 목록 조회
		List<CheckBoard> boardList = dao.selectBoardList(conn, pagination, type);
	...
	public Map<String, Object> checkSearchBoardList(int type, int cp, String key, String query) {
