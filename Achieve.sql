...
ALTER TABLE NOTE ADD PROJECT_NO NUMBER;
...
SELECT PROJECT.PROJECT_NO , PROJECT_NM, MEMBER_NICK, PROJECT_INTRO
FROM PROJECT
JOIN PROJECT_MEMBER ON(PROJECT.PROJECT_NO = PROJECT_MEMBER.PROJECT_NO)
JOIN MEMBER ON(PROJECT.MEMBER_NO = MEMBER.MEMBER_NO)
WHERE PROJECT_MEMBER.MEMBER_NO = 1;



SELECT PROJECT_NO, MEMBER_NO FROM PROJECT WHERE PROJECT_NO = 
	(SELECT PROJECT_NO 
	FROM (
		SELECT PROJECT_NO FROM PROJECT ORDER BY PROJECT_NO DESC
	)
	PROJECT WHERE ROWNUM = 1
);
...
INSERT INTO PROJECT VALUES(
    SEQ_PROJECT_NO.NEXTVAL, '개발4팀', '6', DEFAULT, '배고파', '1'
);
...
INSERT INTO PROJECT_MEMBER VALUES(14, 1);

commit;


SELECT MEMBER_NO FROM PROJECT_MEMBER WHERE PROJECT_NO = 1;
